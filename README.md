...
<br>$\color{orange}{\textsf{[16.]}}$ 🛠 $\color{orange}{\textsf{Blockchain:}}$ I have implemented blockchain technologies, including smart contracts, DeFi, cryptocurrency exchanges, and secure wallet development.
<br>$\color{orange}{\textsf{[17.]}}$ 🧪Experienced in testing frameworks like Selenium and Appium, ensuring high-quality software delivery.
